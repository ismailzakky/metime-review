package com.cus.metime.review;

import com.cus.metime.review.client.OAuth2InterceptedFeignConfiguration;
import com.cus.metime.review.config.ApplicationProperties;
import com.cus.metime.review.config.DefaultProfileUtil;
...
public class ReviewApp {
    ...
    public ReviewApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(ReviewApp.class);
